export const ResumeMock = [
  {
    ...
    'fields': [
      ...
      },
      {
        ...
        'position': 'Administrative Assistant for Quality Management',
        'company': 'Rigiline Ind. e Com. de Plásticos',
        'description': 'Development routines for quality assurance using quality tools, developed indicative graphics for quality control, documentation control.'
      },
      {
        'flagShowHide': true,
        'period': 'February 2009 - May 2009',
        'position': 'Computing Instructor',
        'company': 'Escotec School',
        'description': 'I taught computer science at basic level, Windows, Office 2007, Internet.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    'fields': [
      ...
      },
      {
        ...
        'company': 'Alura Online Courses',
        'description': 'Application development in NodeJS using ExpressJs, creation of Rest API.'
      },
      {
        'flagShowHide': true,
        'period': 'June 2017',
        'position': 'Git: control and share your code',
        'company': 'Alura Online Courses',
        'description': 'Basic git cycle, understanding version control system, working with branches.'
      }
    ]
  }
]
